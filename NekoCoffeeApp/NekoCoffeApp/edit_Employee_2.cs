...
namespace UI
{
    public partial class edit_Employee_2 : Form
    {
        string MasterUsername;
        public edit_Employee_2(string masterUserName)
        {
            InitializeComponent();
        ...
        private void edit_Employee_2_Load(object sender, EventArgs e)
        {
            try
            {
