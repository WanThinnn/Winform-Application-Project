...
namespace UI
{
    public partial class UserBookTable : Form
    {

        private static UserBookTable _instance;
        public static UserBookTable Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UserBookTable();
                return _instance;
            }
        }
        ...
        private void UserBookTable_Load(object sender, EventArgs e)
        {
            try
            {
