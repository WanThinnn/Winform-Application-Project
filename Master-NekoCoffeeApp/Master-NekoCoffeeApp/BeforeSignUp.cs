...
{
    public partial class BeforeSignUp : Form
    {
        public BeforeSignUp()
        {
            InitializeComponent();
        ...
        private void BeforeSignUp_Load(object sender, EventArgs e)
        {
            try
            {
...
<p style=""color: black;"">Chúng tôi nhận được yêu cầu tạo tài khoản Master mới cho email này của bạn trên Master Neko Coffe App. Để hoàn tất quá trình này, vui lòng làm nhập mã xác thực sau:</p>
...
Neko Coffe Team.</p>";
        ...
        private async void btnSignUp_Click(object sender, EventArgs e)
        {
            ...
            // Nếu email chưa tồn tại, tạo và gửi mã xác nhận
            ...
            SignUp signup = new SignUp(verificationInfo, txbEmail.Text);
